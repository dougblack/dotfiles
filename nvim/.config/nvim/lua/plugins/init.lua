return {
	...
	},
	{
		...
		config = function()
			-- optional: map a key to manually import the symbol under the cursor
			vim.keymap.set(
				"n",
				"<leader>ai",
				require("lspimport").import,
				{ noremap = true, desc = "Auto import symbol" }
			)
		end,
	},
	{
		...
		config = function()
			require("conform").setup({
				...
				format_on_save = {
					timeout_ms = 500,
					lsp_fallback = true, -- Fallback to LSP formatting if no conform formatters are found
				},
			})
