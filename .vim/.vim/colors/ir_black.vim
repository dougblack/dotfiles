...
" General colors
hi Normal           guifg=black     guibg=#1A1A1A       gui=NONE      ctermfg=NONE        ctermbg=NONE        cterm=NONE
hi NonText          guifg=black     guibg=#1A1A1A       gui=NONE      ctermfg=black       ctermbg=NONE        cterm=NONE
